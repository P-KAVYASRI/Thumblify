...
export const featuresData: IFeature[] = [
    {
        ...
        description: "Our AI analyzes your content and design preferences to create thumbnails that resonate with your audience, increasing click-through rates and engagement.",
    },
    {

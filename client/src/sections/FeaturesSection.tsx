    ...
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                    Our AI-powered thumbnail generator is designed to help you create eye-catching thumbnails that drive clicks and engagement. With our smart analysis, you can easily create thumbnails that resonate with your audience, increasing your click-through rates and boosting your content's visibility. Whether you're a content creator, marketer, or business owner, our tool is here to help you stand out in the crowded digital landscape.
                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">Boost your content's visibility</h3>
